                    ...
                    <>
                      <Tr>
                        <Th isNumeric className="padding0">
                          <Text color={'black'} fontSize={'small'} fontWeight={500}>Cant.</Text>
                        </Th>
                        <Th>
                          <Text color={'black'} fontSize={'small'} fontWeight={500}>Descripción</Text>
                        </Th>
                        <Th isNumeric className="paddingX0">
                          <Text color={'black'} fontSize={'small'} fontWeight={500}>Total</Text>
                        </Th>
                      </Tr>
                    </>
                  )}
