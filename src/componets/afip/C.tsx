...
export const C = ({ cashMovement, settings }: Props) => {
  ...
  return (
    ...
    >
...

      {
        showTicket
          ?
          <TicketC cashMovement={cashMovement} newDiscount={newDiscount} newRecharge={newRecharge} newSubTotal={newSubTotal} printRef={printRef} settings={settings} />
          :
          <FacturaC cashMovement={cashMovement} newDiscount={newDiscount} newRecharge={newRecharge} newSubTotal={newSubTotal} printRef={printRef} settings={settings} someDiscount={someDiscount} />
      }
